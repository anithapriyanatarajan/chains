...
Kubernetes allows to set up a cluster where workloads can get ServiceAccount tokens from a volume. By enabling Workload Identity Federation, we allow these tokens to be used by workloads to authenticate with Google Cloud services. This way there is no hardcoding of keys or sensitive info required for authentication.
...
> **Note**: We need to edit the chains deployment to include the configmap volume mount, corresponding volume and an environment variable. Below is the sample deployment yaml for `tekton-chains-controller` with volume Mounts -`workload-identity-credential-configuration`,`token`; volumes - `workload-identity-credential-configuration`,`token` and an env variable `GOOGLE_APPLICATION_CREDENTAILS`
  ...
  template:
    metadata:
      labels:
        ...
        app.kubernetes.io/name: controller
        app.kubernetes.io/part-of: tekton-chains
        pipeline.tekton.dev/release: v0.24.0
        version: v0.24.0
    spec:
      containers:
      - env:
        ...
        image: ghcr.io/tektoncd/chains/controller-92006fd957c0afd31de6a40b3e33b39f:v0.24.0@sha256:021fa0056336964649858a1bed7879ee078cd0502d36caa54b52d283b0978299
...
[
  {
    "name": "taskrun-default-kaniko-chains-run-vqtx7/4557b967660a.cert"
  },
  {
    "name": "taskrun-default-kaniko-chains-run-vqtx7/4557b967660a.chain"
  },
  {
    "name": "taskrun-default-kaniko-chains-run-vqtx7/4557b967660a.payload"
  },
  {
    "name": "taskrun-default-kaniko-chains-run-vqtx7/4557b967660a.signature"
  },
  {
    "name": "taskrun-default-kaniko-chains-run-vqtx7/taskrun-435c7963-7a49-4675-a586-2088bd6b713d.cert"
  },
  {
    "name": "taskrun-default-kaniko-chains-run-vqtx7/taskrun-435c7963-7a49-4675-a586-2088bd6b713d.chain"
  },
  {
    "name": "taskrun-default-kaniko-chains-run-vqtx7/taskrun-435c7963-7a49-4675-a586-2088bd6b713d.payload"
  },
  {
    "name": "taskrun-default-kaniko-chains-run-vqtx7/taskrun-435c7963-7a49-4675-a586-2088bd6b713d.signature"
  }
]
```
...
```
gcloud storage cp "gs://tekton_artifacts/taskrun-default-kaniko-chains-run-vqtx7/taskrun-435c7963-7a49-4675-a586-2088bd6b713d.signature" .
```